<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="dich-vu.aspx.cs" Inherits="tin_tuc" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="site" class="corner">
        <div class="">
            <a id="A4" href="~/" runat="server"><i class="fa fa-home"></i></a>/<span>Dịch Vụ</span>
        </div>
    </div>
    <div class="du-an">
        <div class="duan-items">
            ...
            <asp:ObjectDataSource ID="odsDichVu" runat="server" SelectMethod="ProjectSelectAll" TypeName="TLLib.Project">
                <SelectParameters>
        ...
        <div class="pager">
            ...
            <asp:DataPager ID="DataPager1" runat="server" PageSize="12" PagedControlID="lstDichVu">
                <Fields>
