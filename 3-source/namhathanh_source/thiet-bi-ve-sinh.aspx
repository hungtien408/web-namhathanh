<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="thiet-bi-ve-sinh.aspx.cs" Inherits="san_pham" %>
        ...
        <div class="list-sp-carousel owl-carousel">
            ...
            <asp:ObjectDataSource ID="odsSanPhamMoi" runat="server" SelectMethod="ProductSelectAll"
                ...
                <SelectParameters>
                    ...
                    <asp:Parameter DefaultValue="17" Name="CategoryID" Type="String" />
