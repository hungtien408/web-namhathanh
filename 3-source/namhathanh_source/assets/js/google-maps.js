...
//Thay dia chi web
var endAddress = "10.723156, 106.600956";
//Thay toa do
var lat = 10.723156, long = 106.600956;
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        // Creating the content  
            ...
            '<h1>Nam Hà Thành</h1>' + '<ul>' +
            '<li>Địa chỉ: 1082 - 1084 QL1A, Phường Tân Tạo A, Quận Bình Tân, Tp. HCM</li>' +            '<li>Hotline: 0903 674 010</li>' +
            '<li>Email: <a href="mailto:viglaceranht.com@gmail.com">viglaceranht.com@gmail.com</a></li>' + '</ul>'
        '</div>';
