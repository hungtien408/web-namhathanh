<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="info.aspx.cs" Inherits="ad_single_project" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProjectID" SortExpression="ProjectID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn DataField="ProjectTitle" HeaderText="Hotline" SortExpression="ProjectTitle" />
                    <asp:GridBoundColumn DataField="Tag" HeaderText="Facebook" SortExpression="Tag" />
                    <asp:GridBoundColumn DataField="MetaTittle" HeaderText="Điện thoại" SortExpression="MetaTittle" Visible="false" />
                    <asp:GridBoundColumn DataField="MetaDescription" HeaderText="Fax" SortExpression="MetaDescription" Visible="false" />
                    <asp:GridBoundColumn DataField="TagEn" HeaderText="Email" SortExpression="TagEn" Visible="false" />
                    <asp:GridBoundColumn DataField="ProjectTitleEn" HeaderText="Tiêu đề(En)" SortExpression="ProjectTitle" Visible="false" />
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Công Ty</h3>
                            ...
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước px x px)</span>
                                    </td>
                                </tr>
                                <tr>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            ...
            <asp:TextBoxSetting EmptyMessage="Facebook ...">
                <TargetControls>
            ...
            <asp:TextBoxSetting EmptyMessage="Hotline ...">
                <TargetControls>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="4" Name="ProjectCategoryID" PropertyName="SelectedValue"
                Type="String" />
